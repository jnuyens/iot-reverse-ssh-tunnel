...
#Based upon initial version of rsshd from Emmanuel Frecon, Copyright 2016

# Setup the sshd server properly and generate rootpw if needed
# Settings directory
SDIR=/etc/ssh

#generate rootpw if it is not set in the dockerfile
if [ -z "$PASSWORD" ]; then
